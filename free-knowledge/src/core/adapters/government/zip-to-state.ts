// Static zip code prefix → state mapping
// Uses the first 3 digits of a zip code to determine the US state.
// Source: USPS zip code prefix allocations
